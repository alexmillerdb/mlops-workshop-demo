...
git add README.md docs .gitignore mlops_project_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_project_demo/databricks.yml](../mlops_project_demo/databricks.yml) file.
...
Follow the instructions in [mlops_project_demo/resources/README.md](../mlops_project_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_project_demo/resources/README.md)  to propose, test, and deploy
