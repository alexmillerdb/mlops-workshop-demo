...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_project_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlops_project_demo/mlops_project_demo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops_project_demo/mlops_project_demo-model)
. 
